...
function Works() {
    const publicFolder = `${process.env.PUBLIC_URL}/asserts/Projects/`;
        ...
        <div id="works">
            <section id="latest-works">
                ...
                <div className="projects-container">
                    <div className="project-card project-card-1">
                        <div className="project-content">
                            ...
                            <div className="project-image">
                                <img 
                                    src={publicFolder + "slated-homepage.png"} 
                                    alt="Slated.ai Project Screenshot" 
                    ...
                    <div className="project-card project-card-2">
                        <div className="project-content">
                            ...
                            <div className="project-image">
                                <img 
                                    src={publicFolder + "2.webp"} 
                                    alt="Onpassive Project Screenshot 1" 
                                    className="project-img-1" 
                                />
                                <img 
                                    src={publicFolder + "1.webp"} 
                                    alt="Onpassive Project Screenshot 2" 
                                    className="project-img-1" 
                                />
                                <img 
                                    src={publicFolder + "3.webp"} 
                                    alt="Onpassive Project Screenshot 3" 
                                    className="project-img-1" 
                                />
                            </div>
                        </div>
                    ...
                    <div className="project-card project-card-3">
                        <div className="project-content">
                            ...
                            <div className="project-image">
                                <img 
                                    src={publicFolder + "Mb.png"} 
                                    alt="Mission Bhagiratha Project Screenshot" 
                ...
                <div className="all-projects">
                    ...
                    <p>* Some projects are not allowed to publish by NDA<br />if you want to see more. <a href="#contact">CONTACT</a></p>
                </div>
            </section>
        </div>
    )
