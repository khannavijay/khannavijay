          ...
          <div className="div1 eachdiv">
            <div className="userdetails">
              ...
              <div className='socialLinks'>
                <ul>
                  <li><i className="fa-brands fa-linkedin-in"></i><a href="#"></a></li>
                  <li><i className="fa-brands fa-github"></i><a href="#"></a></li>
                  <li><i className="fa-regular fa-envelope"></i><a href="#"></a></li>
                </ul>
          ...
          <div className="div5 eachdiv">
            <div className="userdetails">
              ...
              <div className="detbox">
                ...
                <p className="designation">Verified Graduate</p> ̰
              </div>
            </div>
            <div className="review">
